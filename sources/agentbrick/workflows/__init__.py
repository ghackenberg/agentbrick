...
def call_architecture_model_agent(state: MainWorkflowState) -> MainWorkflowState:
    ...
    state["architecture_top_level_component_names"] = answer["messages"][
        -1
    ].content.splitlines()
...
main_workflow_graph.add_node(
    "architecture_description_agent", call_architecture_description_agent
)
...
main_workflow_graph.add_edge(
    "architecture_description_agent", "architecture_model_agent"
)
